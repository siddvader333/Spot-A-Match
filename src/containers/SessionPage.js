                ...
                <div className="row">
                    ...
                    <div className="song-queue col-md">
                        ...
                        <div className = "song-list">
                            <div className ="song-list-inner"> {/**idk how to make the scroll margin chage so making a extra div */}
                                <SongBlock songName = "Gang Up" songArtist = "Young Thug, 2 Chainz, Wiz Khalifa, Pnb Rock"/>
